...
import { TaskGuide } from "@/components/MilestoneDashboard";
    ...
    <m.div
      ...
      >
        ...
        >
          ...
          {task.milestoneTask.action_required && (
            <div className="mt-3">
              <span className="label-mono">What to do</span>
              <p className="mt-0.5 text-sm text-ink-700">{task.milestoneTask.action_required}</p>
            </div>
          )}

          <div className="mt-3">
            <TaskGuide task={task.milestoneTask} shareUrl={shareUrl} />
          </div>
